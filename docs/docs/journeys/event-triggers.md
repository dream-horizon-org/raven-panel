...
Event triggers determine when journeys activate. They represent user actions or system occurrences that you want to respond to with targeted engagement.
